<template>
  <div class="p-2">
    ...
    <div class="py-2 flex justify-end items-center">
      <UButton block square color="amber" @click="openModal" variant="solid" size="sm" icon="material-symbols:list-alt-add-outline-rounded"> Ürün Ekle </UButton>
    </div>
    <div>
    ...
    <template v-else>
      <ClientOnly>
        <div v-if="items && items.length > 0" class="border border-gray dark:border-gray-700 font-light p-2 rounded-xl overflow-auto">
          <!-- Header -->
